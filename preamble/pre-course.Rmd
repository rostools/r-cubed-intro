...
8.  Read the Code of Conduct (@sec-conduct).
...
course, refer to the RStudio Cloud setup guide
(@sec-setting-up-rstudio-cloud).
...
![Interface to
RStudio.](../images/rstudio-introduction.png){#fig-rstudion-introduction}
...
{{< video ../video/rstudio-installing-remotes.mp4 >}}
...
{{< video ../video/console-installing-r3.mp4 >}}
...
it now**. The survey involves a question about Conduct. We want to make
