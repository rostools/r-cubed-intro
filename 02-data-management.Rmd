...
We've been so far using a teaching dataset that we load from a package, mainly to focus on getting familiar with data wrangling. However, there will come a time when you'd want to wrangle your own data.
