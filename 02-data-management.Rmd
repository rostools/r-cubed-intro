...
We've been so far using a teaching dataset that we load from a package, mainly
to focus on getting familiar with data wrangling. However, there will come a
time when you'd want to wrangle your own data.
...
- Make your tables longer with `pivot_longer()`, suited for the split-apply-combine technique - but take care with `pivot_wider()`, which might make the table wide but less tidy
