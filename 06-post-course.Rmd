...
A showcase of how the reproducible work-flow we've gone over in the course is possible in a restricted virtual environment. Case in point: The virtual desktop environment used when working on Statistics Denmark's researcher services
...
```{r dst-git-setup, echo=FALSE, fig.cap="It works."}
...
**Notice in Figure \@ref(fig:dst-git-remote) how the Pull and Push icons now have colours:**
```{r dst-git-remote, echo=FALSE, fig.cap="It works."}
knitr::include_graphics(here::here("images/dst_git_Works.jpg"))
```
