# Data visualization and best practices {#ggplot2}
...
Making graphs in R is fairly easy with very little code... so easy in fact that
...
- Though commonly used, *[avoid barplots]* with error bars
- Reduce non-data ink or "chartjunk" (e.g. anything on plot that isn't relevant to the data)
- Enhance the data ink (see [here](http://www.sealthreinhold.com/school/tuftes-rules/rule_one.php))
- Use colour to highlight and enhance your message, not just for visual beauty
- Use a colour-blind friendly palette (more on this below)
...
- [Data Visualization: A practical introduction](http://socviz.co/index.html#preface) (a free online book)
