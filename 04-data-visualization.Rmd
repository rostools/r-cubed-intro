...
## Summary of session
- Use “Grammar off Graphics” ggplot2 to plot your data wrangled with `tidyverse` 
- Prioritise to plot raw data data instead of summaries
- Define 4 levels of grammar: `aes()` (what data to plot), `geom_` (e.g. `geom_bar()` what kind of plot), `scale_` (making ht plot pretty) and `theme_` (controls the surroundings of the plotting area)
