...
package. Hit "Enter" and the r3 helper package will be installed. Watch
the video below to see how to do this. **Note**, what you see in the
video (no audio) may look different from yours.
