...
Open your RStudio and watch the video (no audio) below to see how to do
this:

<!-- TODO: Convert to picture using the Console -->
...
Console to install the r3 package. Hit "Enter" and the r3 helper package
will be installed. Watch the video below to see how to do this.
**Note**, what you see in the video (no audio) may look different from
yours.

::: {.callout-warning appearance="default"}
You might encounter an error when running the below code. That's ok, if you
