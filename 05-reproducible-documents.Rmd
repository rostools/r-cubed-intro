...
If you download an image and intent to use it in an official document,
...
You can also directly include a link instead of downloading Can also include links to images from the Internet, as a URL link.


Let's create a new code chunk ("Ctrl+Alt+I")
...
You can insert plots by including a code chunk, like the one below. 
The options added to the code chunk tell it to
