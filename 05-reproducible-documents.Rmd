...
R Markdown is a file format (though still plain text like R scripts or `.csv` files)
that allows you to be more reproducible in your analysis 
and more productive in general in your work.
...
Inside the file is some basic content that gives a brief overview of how to use it.
