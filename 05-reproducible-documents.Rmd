...
It's now time to start putting things together as a HTML report which is easy to read.
- Create a new R Markdown document in `doc/`
- Try to do some of the following tasks in the R Markdown document;
    - Under a new headline, start by including a list with your names, add affiliations as footnotes and provide links for your university or institution
    - Make a new code chunck called `summary-table`. 
    Make sure it runs every time and warnings are shown, but the code is suppressed. 
    Make a table with summary data from your data set for selected variables. 
    Find the mean, standard deviation, minimum and maximum values. Provide the table with an appropriate caption. 
...
- Assign a beautiful theme to your HTML report.
