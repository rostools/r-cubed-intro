...
**Take about 8 min to read over the first few parts of this section, then move to the next exercise. You can also access a quick guide using the RStudio menu: "Help -> Cheatsheets -> R Markdown Cheat Sheet"**.
