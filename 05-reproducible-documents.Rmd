...
- Try to do some of the following tasks in the R Markdown document;
    ...
    - In the end your report, create a new code chunk named `final_picture`, insert a picture that describes the group work. Give it a caption, center it, and let it fill 50% of the document. Suppress the code and warning messages in the R chunk but make sure the code is evaluated. 
