...
**Take about 5 min to read over the first few parts of this section, then move to the next exercise. Please continue reading the remaining parts of this section in your own time. You can also access a quick guide using the RStudio menu: Help --> Cheatsheets --> R Markdown Cheat Sheet**.
