...
- Try to do some of the following tasks in a R Markdown document;
    ...
    - Make a new code chunck called `summary-table`. Make sure it runs every time and warnings are shown, but the code is suppressed. Make a table with summary data from your data set for varialbes that you have selected. Find the mean, standard deviation, minimum and maximum values. Provide the table with an appropriate caption. Make sure all column names starts with lower case, and align the columns to be left-centered. Use a setting to make the numbers in the table have a similar number of digits. 
