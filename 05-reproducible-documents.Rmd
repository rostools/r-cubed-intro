# Creating dynamically generated, reproducible documents {#reproducible-documents}

![](https://img.shields.io/badge/document%20status-in%20progress-orange?style=flat-square)

> Session goal: To create your own document, with embedded code that
automatically adds a figure, a table, and some text results.

See the [Additional Resources for R Markdown](#resources-rmd) page for recommended
resources to use.
...
to make sure the analysis is reproducible.
    - **Note**: For now, *don't* add and commit the HTML report.
...
knit the `.Rmd` document to create the HTML file,
then add-commit-push that file to GitHub.
