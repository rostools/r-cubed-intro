...
that are tidy enough to start working from. Preferably, different teams
choose different datasets so not everyone is using the same dataset. The
lead instructor will coordinate this.
...
You will be pushing and pulling a lot of content (which you will learn
how to do later), so you will need to maintain regular and open
communication with your team members.

Your specific tasks are:

1.  All team members need to **clone your team's repository to their own
    computer**, using the process we learned in @sec-remotes-setting-up.
