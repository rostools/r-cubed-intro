...
However, RStudio has a very nice interface for working with Git,
so we'll be using that interface for this session.
While the RStudio interface doesn't provide as much power 
and features as the terminal,
it provides nearly all other uses.
...
2. Add a one or two sentence simple 
