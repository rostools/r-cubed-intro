...
add a new line to the `R/version-control-session.R` with an R comment (starts with a `#`).
...
TODO: Image of remotes with push and pull

TODO: Image of workflow and stages

### Exercise: Push and pull

### Collaborating using Git and GitHub 

TODO: Image of remotes with collaborator

TODO: Image of conflict
