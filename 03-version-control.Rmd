...
```{r image-git-upload-file-github, echo=FALSE, fig.cap="GitLab: Select Upload filea from the Add files drop-down menu."}
knitr::include_graphics(here::here("images/image-git-upload-file-github.png"))
```

```{r image-git-upload-file-gitlab, echo=FALSE, fig.cap="GitLab: Select Upload file from the + drop-down menu."}
knitr::include_graphics(here::here("images/image-git-upload-file-gitlab.png"))
```
