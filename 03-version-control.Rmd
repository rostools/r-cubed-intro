...
insert_video(here::here("images/github-new-repository.mp4"))
```
...
insert_video(here::here("images/rstudio-clone-repository.mp4"))
```
...
knitr::include_graphics(here::here("images/github-link-existing-repository.png"))
```
...
insert_video(here::here("images/github-edit-and-commit-file.mp4"))
```
...
insert_video(here::here("images/github-add-collaborator.mp4"))
```
