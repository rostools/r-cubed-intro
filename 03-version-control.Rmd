...
```{r image-git-stages-with-github, echo=FALSE, fig.cap="Which states get pushed and pulled."}
...
At this point, 
you decide what to keep and what to remove by deleting text within the "version-control-session.R" script in Rstudio.
