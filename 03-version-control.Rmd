...
This is mostly because this topic requires you to change your normal habits 
of how you work more than how using R would change your habit.
...
so when you synchronise with the remote,
...
Something to consider when using GitHub, 
especially in relation to health research,
is that you need to be careful what you save into the Git history
and what you put up online. Some suggestions are:

- Don't save any personal or sensitive data or files in your Git repository
...
Ok, we now have a remote repository to work from.
In order to get a local copy on your computer,
you need to download (called "clone") it.
The easiest way to do that is to use RStudio's 
...
1. Using the `practice-repo` project you just created, 
...
TODO: Video or gif of making an edit to a file on GitHub
...
TODO: Side by side image of the two versions of the files, and the difference

TODO: Image of merge conflict, indicating what part is from where.
