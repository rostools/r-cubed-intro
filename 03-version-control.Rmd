...
insert_video("images/github-new-repository.mp4")
```
...
insert_video("images/rstudio-clone-repository.mp4")
```
...
insert_video("images/github-edit-and-commit-file.mp4")
```
...
insert_video("images/github-add-collaborator.mp4")
```
