...
3. The panel that lists the file's that have been modified in some way.
...
Green highlight indicated something has been added,
...
below shows an example log of the history of this lesson,
