...
While many people obviously use Git to manage their R projects, you can work with other non-code file types in Git. In the previous section, you learned that you can load in datasets of many file types, including `.csv` and `.rda` files. You can also import image files, `.zip` files, Word documents, and PDFs. Version control is useful for any project as any type of documentation should have a full history and the ability to revert to an earlier version if that becomes necessary. You can upload files from within your repository on GitHub or GitLab, as pictured below.
