...
htmltools::tags$video(src = here::here("images/github-new-repository.mp4"))
```
...
htmltools::tags$video(src = here::here("images/rstudio-clone-repository.mp4"))
```
...
For this session, 
you've all been added as collaborators to your group's repository,
so you'll get practice working with others when doing the final exercise.
