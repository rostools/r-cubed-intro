...
## Exercise: Adding figures and change the theme
...
R Markdown file. Download it, create a new folder in `doc/` called `images/`,
and save the image there.
    - In the R Markdown file, insert the image somewhere (e.g. under `# Results`)
    and give it an appropriate caption. The location of the image when using Markdown
    syntax would be e.g. `image/image-name.png`.
...
in the YAML header and re-knitting the document. 
