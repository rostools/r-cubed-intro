...
- Describe what you did and the reasons behind
...
jumping into the exercises. You are likely to push and pull a lot of content
...
You can (and probably should) distribute the tasks of exploring the data and figuring
out what should be or needs to be cleaned in the dataset.
It also makes sure that you as a group have a good understanding of the data.
