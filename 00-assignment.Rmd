...
and apply it to create a reproducible project. This project, based on a simple data analysis of a dataset of your choice, will have a GitHub repository and be reported as an HTML document to highlight the reproducibility. 
...
- Give *concrete* suggestions on how things, that was found challenging, could have been handled.
