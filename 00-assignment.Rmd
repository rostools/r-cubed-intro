...
1. Create a project using the "New Project" setup with the necessary files
(covered in [Project Management](project-management.html)).
2. Find an "open" dataset to use for your analysis and report.
...
6. Create an R script in your `R/` folder that generates and saves one or more figures that
...
7. Create an R Markdown document called `report.Rmd` in the `doc/` folder of your project
...
8. Generate an HTML of the report.
...
- Project on GitHub
- Used Git
- Has a good README describing the project and the team
