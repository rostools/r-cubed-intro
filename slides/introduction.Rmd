...
## 🚶🚶‍♀️ Who has not yet used R? {.center}

::: notes
Go to different sides of the room for "Yes" and "No"
:::

## 🚶‍♀️🚶Those who've used R, how do you perceive your skill in R? {.center}

::: notes
Arrange along the wall from beginner to advanced.
:::

## 🙋Those who've used R or other coding tool (like Stata), have you had formal training in "coding" in it? {.center}

## 🚶🚶‍♂️🚶‍♀️How do you perceive your general skill in data analysis? {.center}

## Ok, bet back into your groups
