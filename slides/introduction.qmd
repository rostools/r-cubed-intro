...
-   :heavy_check_mark: Pick a table name from the basket and go to that
    table
...
## Using "AI" tools means you need to be *more skilled* in coding, not less {.center}
...
-   Every morning, draw a table names from the bowl, sit at that table,
...
With the final team project, you'll be in the same team for the
...
I've tried to organize the teams to include a range of skills and
...
::::: columns
::: column
-   Put the origami hats :tophat: on your laptop to get help
...
too slow, especially during this introductory workshop. Ideally,
everyone would say it was the perfect speed. But that is impossible to
achieve. So instead, we aim as much as possible to have fewer people say
it was too fast than people who say it was too slow. This is an
introduction workshop, so we're trying to assume as little to no
knowledge on many of these concepts. So, for those with some knowledge,
it *will* feel slow at times! You can always help your neighbour out to
help pass the time
:::
