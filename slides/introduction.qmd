...
## Only 25% could be *executed* without some "cleaning up" [@Trisovic2022]
...
::: {.column width="50%"}
-   Reading tasks, discussion activities, and exercises are all clearly 
    marked as separate headers
