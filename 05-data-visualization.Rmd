...
a new code chunk named "discrete-variables" below it. Copy and paste the code below into the new code chunk.
...
variables. Copy and paste the code below into a new code chunk named "continuous-variables".
