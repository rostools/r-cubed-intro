...
format. Delete unneeded text and code chunks, then save this file as
`visualization-session.Rmd` in the `doc/` folder. We will use this file for
the code-along and exercises in for the data visualization session.
...
item `Code -> Insert Chunk` Then add this to the first code chunk:
