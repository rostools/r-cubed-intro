...
Before we move on, let's add and commit the new files we created into the Git
history and push up to
...
function, specifying the theme you want in the parenthesis.
