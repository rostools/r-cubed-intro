...
and then briefly talk about the section overall.
But no need to go into a lot of detail... they did just read it.
- For the exercises, 
...
You will likely need to make a newline more often then you would normally typing code.
For instance, instead of:
    ...
    You will likely need to make it like:
    ...
    This is much more preferable than to have to scroll horizontally.
