...
The `r-cubed-intro` (Reproducible Research in R or R3) learning module is
...
Both the [*Welcome*](https://r-cubed-intro.rostools.org) and
[*For Teachers*](https://r-cubed-intro.rostools.org/appendix/for-teachers) sections give more
details on how this module can be re-used.

The *target audience* for this learning resource is described in
[*Welcome*](https://r-cubed-intro.rostools.org/) page.
...
[*syllabus*](https://r-cubed-intro.rostools.org/overview/is-this-for-you).
...
[*syllabus*](https://r-cubed-intro.rostools.org/overview/syllabus).
...
[*Schedule*](https://r-cubed-intro.rostools.org/overview/schedule) section.
Details on how these lessons can be used or structured are found in
[*For Teachers*](https://r-cubed-intro.rostools.org/appendix/for-teachers) section.
...
[*Lecture Slides* section](https://r-cubed-intro.rostools.org/sessions/introduction)).
...
[*Welcome*](https://r-cubed-intro.rostools.org) section.
...
The [*For Teachers*](https://r-cubed-intro.rostools.org/appendix/for-teachers) section
