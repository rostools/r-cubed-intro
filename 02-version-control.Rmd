...
and add to the staging and commit the new change.
Next, click the "Push" button in the top right corner of the Git interface
(in box 2 of Figure \@ref(fig:image-rstudio-git-interface)).
...
You should see something like the below text (it may be slightly different):
