...
```{r image-version-control-comics, echo=FALSE, fig.cap="'Final' version of a document, using a simple, and more common and complicated 'version control system'."}
...
or thesis do you have lying around after getting feedback from your supervisor 
or co-authors? 
