...
```{r image-version-control-comics, echo=FALSE, fig.cap="'Final' version of a document, using a common and simple 'version control system'."}
...
2. These are the "Push" and "Pull" buttons that used to synchronize with GitHub, 
...
(e.g. the `.gitignore`, the `.R` files, and the `.Rproj` file).
...
Now let's try the opposite: to commit and pull changes from GitHub to your local repository. 
