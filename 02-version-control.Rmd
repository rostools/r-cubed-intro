...
- Less time findings things, because everything is organized and in one place.
...
```{r image-git-upload-file-github, echo=FALSE, fig.cap="GitHub: Select Upload filea from the Add files drop-down menu."}
