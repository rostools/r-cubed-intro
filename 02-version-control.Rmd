...
When creating the project from prodigenr, Git is usually automatically set up.
...
`origin/master` indicates that the commit comes from the `master` 
(or sometimes called `main`) branch
