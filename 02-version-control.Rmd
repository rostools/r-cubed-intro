...
Tip: If you have a lot of files to stage and you don't need to review each
change: You can stage them all in a single click by pressing `Ctrl-A` to select
all files (`⌘-A` for Mac users) and then clicking the "Staged" checkbox one of the
files.
