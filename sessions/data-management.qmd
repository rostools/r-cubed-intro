...
(`r palette_styler_file`) and commit all the files changes to the Git
history with the RStudio Git interface (`r palette_git_commit`).
...
Before you start the following exercise, run `{styler}`
(`r palette_styler_file`) and commit changes to the Git history
(`r palette_git_commit`).
