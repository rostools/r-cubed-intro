...
Before moving on, run `{styler}` (`r palette_styler_file`) and commit
all the files changes to the Git history with the RStudio Git interface
...
(`r palette_styler_file`) and commit changes to the Git history using
{{< var keybind.git >}}.
