# Importing in data {#sec-import-data}
...
5.  Describe the difference between "messy" and "tidy" data and explain
    why you should aim to create and use tidy data when working with
    data.
...
-   Use `?` to get help on an R object. Use the cheatsheets to help
