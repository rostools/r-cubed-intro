...
`{styler}` with {{< var keybind.styler >}}, render (`r keybind_knit` or
...
code chunk. When you complete each task, run `{styler}` using
{{< var keybind.styler >}} and render (`r keybind_knit` or
