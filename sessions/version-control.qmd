...
1.  Get familiar with the principles and practical applications of
    version control.
...
That's because we've put the change into the history. We can view the
history by clicking the "History" button in the top-left corner of the
RStudio Git interface. Here you can see what has been done in previous
commits.
