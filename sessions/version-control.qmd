...
As an alternative to manually navigating the GitHub settings section,
you can open a direct link to the personal access token website directly
from RStudio. Complete the [Connect to GitHub]() guide for this
