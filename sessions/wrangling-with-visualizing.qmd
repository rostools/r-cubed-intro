...
`docs/` called `images`, and save the image in that folder. Then, in your
...
Create a new header in the `docs/learning.qmd` file called
...
```{r, eval=FALSE}
#| filename: "docs/learning.qmd"
ggsave(here::here("docs/images/scatterplot.pdf"),
  base_scatterplot2,
  width = 7, height = 5
)
```
