...
Run this code chunk with {{< var keybind.run-code >}} and you'll see a plot
...
Run this with {{< var keybind.run-code >}}. One thing you'll quickly notice
...
Run each of these lines of code with {{< var keybind.run-code >}}. You'll see
