...
-   If your collaborators or supervisor don't use these tools from the
    ...
    -   Create all your figures entirely in R and using R scripts or R
        Markdown files.
    -   Write everything research related in R Markdown/Quarto and
        convert to a Word document when you need to send to co-authors.
        If they make edits or comments, include the edits in the
        original R Markdown/Quarto file, and *do not* keep them in the
        Word document.
...
How do you share? Put your code up on any of these sites. We recommend a
