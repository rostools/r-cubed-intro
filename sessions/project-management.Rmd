...
below into the `R/learning.R` file. **NOTE**: *Don't* run this code,
just edit it to improve the code style and object naming. There are some
tricks in here that we haven't covered yet, but will when we go through
the exercise.
