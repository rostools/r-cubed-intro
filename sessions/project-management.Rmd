...
need to do a code-along for this, since we will be using them a lot over
the later sessions.
:::
...
We can do that through the Command Palette (`Ctrl-Shift-P`) and typing
"style file", which should show the "Style active file" option. You'll
try it out in the next exercise.
