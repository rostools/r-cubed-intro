...
## Exercise: Get familiar with the NHANES dataset

> Time: 10 minutes.

Take some time to get to know the NHANES dataset.

1.  Copy the code below and paste it into the `R/learning.R` script
    file.
2.  Replace the `___` with `NHANES`.
3.  Run each line of code by using the `Ctrl-Enter` shortcut.
4.  Take a look at the output for each command, to see what sorts of
    data you are able to retrieve.
5.  Once you have completed each, add and commit the changes to the Git
