...
height by a group, you would use the argument `.by = "group"` inside
`summarise()`. Here, `"group"`refers to the column name you want to
split your data into. This will tell `summarise()` to split the data up
and apply an analysis, then immediately combine it back together.
