...
[^version-control-1]: If you have troubles logging in, you may need to
    update Git.
...
5.  In the GitHub `LearningR` repository, directly edit your `README.md`
    file there. Commit the changes.
6.  In your RStudio `LearningR.Rproj` project, pull the changes you made
    on GitHub.
