...
also render the document with {{< var keybind.render >}} and see what it
looks like. When the HTML document opens, you should see some text below
the `setup` chunk that might look something like this:
