...
the new picture. Now, let's change the width and height of the image as
well as its alignment. We do this by adding a `{}` to the end of the
Markdown image tag and put options inside there.
