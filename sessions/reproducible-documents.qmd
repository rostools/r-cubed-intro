...
1.  Describe what a reproducible document is, explain why it is important, and
    use it to write R code to create an output document.

**Specific objectives** are to:

1.  Describe what Quarto is and how it
    helps with reproducibility, and why it can save you time and effort.
...
4.  Define some basic objects and data types in R and write some simple R code
...
order and in an empty environment (a new R session), the code and
...
LaTeX through the R package [tinytex](https://yihui.name/tinytex/r/),
...
This is the basic approach to creating documents from Quarto.
