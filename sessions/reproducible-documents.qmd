...
Reproducibility is a cornerstone of good scientific practice. One of the
first ways to ensure your report or paper is reproducible is by ensuring
the results you show are directly generated from the code you used to do
the analysis. In this session, we will go over how to use
[Quarto](https://quarto.org/) to write code within a document to make a
big step towards a reproducible analysis.
...
your own later. For this workshop, we will focus on using the normal
mode.
...
you have a Word processor installed. This is the basic approach to
creating documents from Quarto.

## RStudio layout and usage

You've already gotten a bit familiar with RStudio in the pre-workshop
...
using it a lot throughout the workshop. Open it up with
...
experienced from the pre-workshop tasks, installing packages is easy by
...
One "meta-package" we will use throughout the workshop is called
