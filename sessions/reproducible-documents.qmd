...
1.  Describe what a reproducible document is, what Quarto is and how it
...
4.  Become familiar with the very basics of R.
5.  Apply tools to use a consistent "grammar" and "styling" when writing
