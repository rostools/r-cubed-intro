...
1.  In the `doc/learning.qmd` file, create a new header called
    ...
    `prettier-table`. Copy the code below at the end of this exercise
    (that we wrote above) and paste the code into the new chunk. Add the
    option `#| echo: false` to the code chunk.
...
> (`Tools -> Cheatsheets`) and Quarto's [Markdown
