...
For this course, you will spend most of your time using R script files to write and play around with code. However, we will also take a look at R Markdown (.Rmd) files later in the course. R Markdown is a dynamic and invaluable tool that will help you to ensure reproducibility. Whereas scripts are a blank slate for entering endless lines of code, R Markdown allows you to enter code chunks surrounded by text/images and then convert to MS Word, PDF, or HTML to produce a report. Some researchers write and manage entire papers using R Markdown, as it can make things easier to organize and maintain.
