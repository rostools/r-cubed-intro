...
issues in the pre-course survey. 
...
dividing the screen into four the four corners.
...
how the panels are shown is the default layout.
...
Almost all of the tasks below will use the Console.
...
Afterward, type and run this next command to make sure everything is ok with the Git configuration.
...
there is also the final group [project assignment](assignment) 
