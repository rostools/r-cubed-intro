...
You can customize where the panels go, but how the panels are shown is the default.
...
This is the "engine". Almost all of the tasks below will use the Console.
- Panel "C"
