...
- [`R/` chapter in R Packages](https://r-pkgs.had.co.nz/r.html) book (online and
free).
- [Documenting functions chapter](https://r-pkgs.had.co.nz/man.html) in R
Packages book.
- Very advanced (for those interested) details about functions from [Advanced
R](https://adv-r.had.co.nz/Functions.html) book (again, online and free).
