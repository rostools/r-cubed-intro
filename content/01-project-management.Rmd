...
Throughout this session, because it is the first session, take it slowly.
Talk through the basics of R, including emphasizing how to troubleshoot or get
help. Check for participants' understanding using the stickies.
")`
...
So your file path `R/package-loading.R` won't work because there isn't a folder
