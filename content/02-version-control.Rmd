...
need to use a "Personal access token". These tokens are needs to be manually
generated on Github, and is a more secure way for us to communicate with our 
Github account and repositories.
As the process of creating a token can be confusing, the entire process 
...
in RStudio.
The personal access token will only be visible at the time of its creation, so 
remember to copy it before closing the browser window.
